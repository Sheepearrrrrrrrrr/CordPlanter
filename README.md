...
## Notice
This is really early stage and it only has stuff for me to debug code and the rough outlines for me to eventually add more methods and expressions that can be used.
## Usage
There is a papermc 1.21.8 version which you can compile from source. On first run it will create a workspaces directory in it's config directory, in which you can put your workspaces. If you want an example workspace to look at, take a look at `command_test.json` for command definitions and `enchantment_test.json` for enchantment definitions in this repository.
